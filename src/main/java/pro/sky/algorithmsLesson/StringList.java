...
public interface StringList {
    ...
    // Удаление элемента.
    // Вернуть удаленный элемент или выдать исключение, если подобный элемент отсутствует в списке.
    ...
    // Поиск элемента.
    // Вернуть индекс элемента или -1 в случае отсутствия элемента.
    ...
    // Вернуть элемент или выдать исключение, если индекс выходит за рамки фактического количества элементов.
